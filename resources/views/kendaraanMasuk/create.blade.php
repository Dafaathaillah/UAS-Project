                        ...
                        <div class="card-block">
                            <form method="post" action="{{ route('kendaraanmasuk.store') }}" id="myForm">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="tahun_pembuatan" name="tahun_pembuatan" class="form-control" id="tahun_pembuatan" class="form-control date" placeholder="tahun_pembuatan">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="tanggal_masuk" name="tanggal_masuk" class="form-control" id="tanggal_masuk" class="form-control date" placeholder="tanggal_masuk">
                                    </div>
                                </div>
